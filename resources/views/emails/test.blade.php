...
<body>
    <div class="back-background">
        <div class="front-background">            
            ...
            <p><strong>!Hola [[ Nombre estudiante ]]!</strong>, recibe un saludo de parte de Uniremington Manizales.</p>
            ...
            <p><strong>Usuario: </strong>[[ Email Medellín ]]</p>

            <p class="space-60"><strong>Contraseña: </strong>[[ Conraseña Medellín ]]</p>
